...
class Phi extends Icon{
  constructor(){
    super(`<svg viewBox="0 0 100 100" style = "height: 1.5em">
...
export {Icon, EditIcon, TickIcon, RadioIcon, TrashIcon, UploadToCloudIcon, LoaderIcon, UploadFilesIcon, LockIcon, AdminIcon, ContentAdminIcon, Arrow, Phi}
